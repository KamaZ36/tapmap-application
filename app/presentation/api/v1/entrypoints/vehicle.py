...
from app.presentation.api.v1.schemas.vehicle import (
    CreateVehicleSchema,
...
@router.post("", summary="Добавить автомобиль для водителя (Только администраторам)")
...
@router.get("/{vehicle_id}", summary="Получить автомобиль по ID")
