...
class CityModel(BaseModel): 
    ...
    state: Mapped[str] = mapped_column(unique=False)
    ...
    service_commission_pct: Mapped[Decimal] = mapped_column(DECIMAL(5, 4), nullable=False)
    
    polygon: Mapped[WKBElement] = mapped_column(Geometry('POLYGON', srid=4326), nullable=False)
    
    
    @classmethod
    def to_model(cls, city: City) -> 'CityModel': 
