...
from app.infrastructure.repositories.blocking_user.sqlalchemy_repository import (
    SQLBlockingUserRepository,
)
from app.infrastructure.repositories.city.base import BaseCityRepository
from app.infrastructure.repositories.city.sqlalchemy_repository import (
    SQLAlchemyCityRepository,
)
from app.infrastructure.repositories.draft_order.base import BaseDraftOrderRepository
from app.infrastructure.repositories.draft_order.redis_repository import (
    RedisDraftOrderRepository,
)
from app.infrastructure.repositories.driver.base import BaseDriverRepository
from app.infrastructure.repositories.driver.sqlalchemy_repository import (
...
from app.infrastructure.repositories.vehicle.sqlalchemy_repository import (
    SQLAlhcemyVehicleRepository,
)
...
class RepositoriesProvider(Provider):
    ...
    @provide
    def get_blocking_user_repository(
        self, session: AsyncSession
    ) -> BaseBlockingUserRepository:
        return SQLBlockingUserRepository(session=session)
