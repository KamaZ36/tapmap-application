...
class GetOrdersInteraction:
    ...
    async def __call__(self, filters: GetOrdersFilters, current_user: CurrentUser) -> list[Order]:
    ...
    def _validate_permissions(self, current_user: CurrentUser, filters: GetOrdersFilters) -> None:
