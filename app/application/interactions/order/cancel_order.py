...
class CancelOrderInteraction:
    ...
    async def __call__(self, current_user: CurrentUser, order_id: UUID, reason: str) -> None:
        ...
        logger.success(f"Заказ {order_id} успешно отменен {current_user.user_id}. Причина: {reason}")
